    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-11 d-flex align-items-center">
          <h1 class="logo mr-auto"><a href="/">Complaint Management System</a></h1>
    ...
    <div class="register-box">
        ...
        <div class="card">
            ...
            <div class="jumbotron jumbotron-fluid py-2">
                ...
                <form method="post" action="{{ route('register_patient_user') }}" id="authenticationForm" class="d-none">
                    @csrf
                    <div class="input-group mb-3">
                        <input type="text" name="phone" class="form-control" placeholder="Enter phone here" autocomplete ="off">
                        <div class="input-group-append">
                ...
                success: function (response, textStatus, jqXHR) {
                    ...
                    setTimeout(
                        function() 
                        {
                            ...
                            location.replace('/patient/authentication');
                        }, 2000);
                },
